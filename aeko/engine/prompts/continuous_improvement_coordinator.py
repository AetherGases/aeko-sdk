...
CONTINUOUS_IMPROVEMENT_COORDINATOR_SPEC = PromptSpec(
    ...
    tasks=[
        ...
        "Consolidar tudo em UM único plano de melhoria: o problema mais crítico e de maior retorno em \"## Problema definido\", o que fazer a respeito em \"## Método\", e por que esse método resolve aquele problema em \"## Raciocínio\"",
        (
